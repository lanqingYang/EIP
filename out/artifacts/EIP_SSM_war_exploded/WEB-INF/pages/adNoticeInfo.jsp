                ...
                <li class=" active  treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="javascript:void(0)" onclick=to("adNoticeCheck")><i class="fa fa-circle-o"></i>
                            公告审核</a></li>
                        <li class="active"><a href="javascript:void(0)" onclick=toWithNotice("adNoticeInfo")><i class="fa fa-circle-o"></i> 公告查看</a>
                        </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="row col-xs-8" style="text-align: right;"  >
                <form action="${pageContext.request.contextPath}/searchAllNoticeByTitle/adNoticeInfo" method="get">
                <input type="text" class="form-control" placeholder="请输入标题" style="width: 30%;display: inline-block;border-radius: 4px;" name="title">
