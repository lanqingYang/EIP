      ...
      <li class=" treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="javascript:void(0)" onclick=to("adNoticeCheck")><i class="fa fa-circle-o"></i>
                                公告审核</a></li>
                            <li><a href="javascript:void(0)" onclick=toWithNotice("userNotice")><i class="fa fa-circle-o"></i> 公告查看</a>
                            </li>
              ...
              <div class="tab-pane  active" id="tab_1">
                ...
                <div class="box-body">
                  <ul class="miaoShu">
                    ...
                    <li class="col-xs-10">
                      <h3>教职工数量</h3>
                      <span><strong><i>${highschool.HSStuffs}</i></strong> </span>
                    </li>
                    <li class="col-xs-10">
                      <h3>专职教师数量</h3>
                      <span><strong><i>${highschool.HSTeachers}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学生总人数</h3>
                      <span><strong><i>${highschool.HSCapacity}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>每年招生人数</h3>
                      <span><strong><i>${highschool.HSCapacityYears}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学校描述</h3>
                      <span><strong><i>${highschool.HSDescription}</i></strong></span>

                    </li>
                    <div class="clear"></div>
                    <div class="form-group col-xs-10">
                      <button type="button" class="btn btn-info col-xs-offset-3"
                              style="margin-top: 20px;" onclick="to('hInfo')">返回
                      </button>
...
<script>
  ...
  function showMap() {
    ...
    var point = new BMap.Point(${highschool.HSPointY}, ${highschool.HSPointX});
 ...
 */
      ...
      datasets: [
        {
          ...
          data                : [${highschool.HSStuffs}, ${highschool.HSCapacity}]
        },
        {
          label               : 'Digital Goods',
          ...
          data                : [${highschool.HSTeachers}, ${highschool.HSCapacityYears}]
        }
      ]
    }
    ...
    var PieData = [
      {
        value: ${highschool.HSStuffs},
        color: "#f39c12",
        highlight: "#f39c12",
        label: "教职工",
      },
      {
        value: ${highschool.HSTeachers},
        color: "#3c8dbc",
        highlight: "#3c8dbc",
        label: "专职教师",
      },
