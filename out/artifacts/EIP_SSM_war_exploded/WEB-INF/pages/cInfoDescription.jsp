              ...
              <div class="tab-pane  active" id="tab_1">
                ...
                <div class="box-body">
                  <ul class="miaoShu">
                    ...
                    <li class="col-xs-10">
                      <h3>教职工数量</h3>
                      <span><strong><i>${college.CStuffs}</i></strong> </span>
                    </li>
                    <li class="col-xs-10">
                      <h3>专职教师数量</h3>
                      <span><strong><i>${college.CTeachers}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学生总人数</h3>
                      <span><strong><i>${college.CCapacity}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>每年招生人数</h3>
                      <span><strong><i>${college.CCapacityYears}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学校描述</h3>
                      <span><strong><i>${college.CDescription}</i></strong></span>

                    </li>
                    <div class="clear"></div>
                    <div class="form-group col-xs-10">
                      <button type="button" class="btn btn-info col-xs-offset-3"
                              style="margin-top: 20px;" onclick="to('cInfo')">返回
                      </button>
...
<script>
  ...
  function showMap() {
    ...
    var point = new BMap.Point(${college.CPointY}, ${college.CPointX});
      ...
      datasets: [
        {
          ...
          data                : [${college.CStuffs}, ${college.CCapacity}]
        },
        {
          label               : 'Digital Goods',
          ...
          data                : [${college.CTeachers}, ${college.CCapacityYears}]
        }
      ]
    }
