  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="col-xs-4" style="margin-top: -16px;">
        ...
        <button class="btn btn-info" style="margin-top:-10px; margin-left: 20px;" onclick=to("adPAddInfo")>
              ...
              <li class="col-md-6" style="float: left;">
                <div class="box box-default">
                  <div class="box-header with-border">
                    <a class="box-title" href="javascript:void(0)" onclick=toWithId("adPInfoDescription","${P.PSId}")>
                        ${P.PSName}</a>
                  </div>
                  <div class="box-body">
                    <p>${P.PSDescription}</p>
                  ...
                  <!-- 新加的按钮 -->
                  <div class="infoList">
                    <button class="btn btn-danger" data-toggle="modal" data-target="#myModal-del" onclick=deleteById("${P.PSId}")>
                      删除
                    </button>
                    <button class="btn btn-warning" onclick=toWithId("adPInfoDesChange","${P.PSId}")>
                      修改<!-- <a href="adKInfoDesChange.html"></a>修改 -->
                    </button>
                    <button class="btn btn-primary" onclick=toWithId("adPInfoDescription","${P.PSId}")>
...
<%--          </button>--%>
<%--          <button type="submit" class="btn btn-primary" style="margin-right: 14px;" onclick=deleteById("${P.PSId}")>--%>
