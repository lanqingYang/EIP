    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-3 col-md-6" style="margin-top: 30px;">
          ...
          <form class="form-horizontal" role="form" style="margin-left: 10%;">
            <div class="form-group">
              <label for="SUQuestion" class="col-sm-2 control-label">密保问题</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
                  ...
                  name="SUQuestion"
                  readonly
                  value="${userSelectByName.SUQuestion}"
                ></input>
              </div>
            </div>
            <div class="form-group">
              <label for="SUAnswer" class="col-sm-2 control-label">密保答案</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <div style="width: 100%; margin-left: -5%;">
                <button
                  ...
                  style="float: none;"
                  onclick=checkAnswer("resetPwd.jsp")
                >
                下一步<!-- <a href="javascript:void(0)" onclick=to("resetPwd)>下一步</a> -->
                </button>
              </div>
            </div>
          </form>
...
-->
  ...
  <script>
    ...
    var input=document.getElementById("SUAnswer");
    var answer="${userSelectByName.SUAnswer}";
    if(answer==input.value){
      window.location.href = "${pageContext.request.contextPath}/" + page;
    }else{
      $("#modal-message").html("密保答案不正确！");
