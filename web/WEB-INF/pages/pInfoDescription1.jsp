            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="javascript:void(0)" onclick=to("pInfo")><i
                            ...
                            <div class="tab-pane  active" id="tab_1">
                                ...
                                <div class="box-body">
                                    <ul class="miaoShu">
                                        ...
                                        <li class="col-xs-10">
                                            <h3>教职工数量</h3>
                                            <span><strong><i>${primarySchool.PSStuffs}</i></strong> </span>
                                        </li>
                                        <li class="col-xs-10">
                                            <h3>专职教师数量</h3>
                                            <span><strong><i>${primarySchool.PSTeachers}</i></strong></span>
                                        </li>
                                        <li class="col-xs-10">
                                            <h3>学生总人数</h3>
                                            <span><strong><i>${primarySchool.PSCapacity}</i></strong></span>
                                        </li>
                                        <li class="col-xs-10">
                                            <h3>每年招生人数</h3>
                                            <span><strong><i>${primarySchool.PSCapacityYears}</i></strong></span>
                                        </li>
                                        <li class="col-xs-10">
                                            <h3>学校描述</h3>
                                            <span><strong><i>${primarySchool.PSDescription}</i></strong></span>

                                        </li>
                                        <div class="clear"></div>
                                        <div class="form-group col-xs-10">
                                            <button type="button" class="btn btn-info col-xs-offset-3"
                                                    style="margin-top: 20px;" onclick="to('pInfo')">返回
                                            </button>
...
<script>
    ...
    function showMap() {
        ...
        var point = new BMap.Point(${primarySchool.PSPointY}, ${primarySchool.PSPointX});
...
<script>
         ...
         */
                ...
                datasets: [
                    {
                        ...
                        data                : [${primarySchool.PSStuffs}, ${primarySchool.PSCapacity}]
                    },
                    {
                        label               : 'Digital Goods',
                        ...
                        data                : [${primarySchool.PSTeachers}, ${primarySchool.PSCapacityYears}]
                    }
                ]
            }
            ...
            var PieData = [
                {
                    value: ${primarySchool.PSStuffs},
                    color: "#f39c12",
                    highlight: "#f39c12",
                    label: "教职工",
                },
                {
                    value: ${primarySchool.PSTeachers},
                    color: "#3c8dbc",
                    highlight: "#3c8dbc",
                    label: "专职教师",
                },
