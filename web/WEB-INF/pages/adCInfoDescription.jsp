                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <ul class="miaoShu">
                                <li class="col-xs-10">
                                    <h3 >地址</h3> <span><strong><i>${college.CAddress}</i></strong> </span>
                                </li>
                                <li class="col-xs-10">
                                    <h3>教职工数量</h3> <span><strong><i>${college.CStuffs}</i></strong> </span>
                                </li>
                                <li class="col-xs-10">
                                    <h3>专职教师数量</h3> <span><strong><i>${college.CTeachers}</i></strong></span>
                                </li>
                                <li class="col-xs-10">
                                    <h3>学生总人数</h3> <span><strong><i>${college.CCapacity}</i></strong></span>
                                </li>
                                <li class="col-xs-10">
                                    <h3>每年招生人数</h3> <span><strong><i>${college.CCapacityYears}</i></strong></span>
                                </li>
                                <li class="col-xs-10">
                                    <h3>学校描述</h3> <span><strong><i>${college.CDescription}</i></strong></span>
                                ...
                                <div class="form-group col-xs-12 ">
                                    ...
                                    <button type="button" class="btn btn-warning col-xs-offset-1" style="margin-top: 30px; margin-left: 30px;" onclick=toWithId("adCInfoDesChange","${college.CId}")>
                                        <!-- <a href="adKInfoDesChange.html"></a> -->
                                        修改</button>

                                    <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 30px;margin-left: 30px;" onclick=to("adCInfo")>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div style="width: 100%;text-align: right;">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-right: 14px;" onclick=deleteById(${college.CId})>
...
<script>
    ...
    function deleteById(id) {
        $.ajax({
            url: "${pageContext.request.contextPath}/deleteCollege/" + id,
            type: "GET",
            success: function (result) {
                if (result == "success") {
                    //window.location.reload();
                    toWithId("adCInfo","${college.CId}")
                } else {
