            ...
            <div class="col-md-12">
              <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">${highschool.HSName}</h3>
                </div>
                <div class="box-body">
                  <div class="box-body " id="inputchoose" >
                    <form class="form-horizontal" id="add_form">
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="1" name="KName" value="${highschool.HSName}" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="2" class="col-sm-2 control-label">地址</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="2" name="HSAddress" value="${highschool.HSAddress}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="3" class="col-sm-2 control-label">教职工数量</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="3" name="HSStuffs" value="${highschool.HSStuffs}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="4" class="col-sm-2 control-label">专职老师数量</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="4" name="HSTeachers" value="${highschool.HSTeachers}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="5" class="col-sm-2 control-label">学生总人数</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="5" name="HSCapacity" value="${highschool.HSCapacity}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="6" class="col-sm-2 control-label">年招生人数</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="6" name="HSCapacityYears" value="${highschool.HSCapacityYears}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="7" class="col-sm-2 control-label">学校描述</label>
                        <div class="col-sm-5">
                            <textarea class="form-control" rows="4" id="7" style="resize: none;" name="HSDescription">${highschool.HSDescription}</textarea>
                        </div>
                      </div>
                      <!-- 隐藏 -->
                      <div class="form-group" >
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="8" value="${highschool.HSPointY}" name="HSPointX">
                        </div>
                      </div>
                      <div class="form-group" >
                        <label for="9" class="col-sm-2 control-label">点坐标Y</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="9" value="${highschool.HSPointY}" name="HSPointY">
                        </div>
                      </div>
                      <!-- 隐藏结束 -->
                      <div class="form-group">
                        <button type="button" class="btn btn-info col-xs-offset-2" style="margin-top: 20px;" id="submitBtn">
                          ...
                          提交</button>
                        <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 20px;" onclick=toWithId("adHInfoDescription","${highschool.HSId}")>
                          <!-- <a href="adKInfoDescription.html"></a>  -->
                          返回</button>
...
<div class="modal-dialog">
  ...
  <script>
    ...
    $('#submitBtn').click(function () {
      ...
      $.ajax({
        url:"${pageContext.request.contextPath}/updateHighschool/${organizationId}",
        type:"POST",
        data:formData,
        processData:false,
        contentType:false,
        success:function (result) {
          if (result == "success"){
            ...
            window.location.href = "${pageContext.request.contextPath}/to/adHInfoDescription/${highschool.HSId}";
          }else{
