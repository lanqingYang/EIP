        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active menu-open">
                    ...
                    <!-- 二级栏目 -->
                    <ul class="treeview-menu">
                        <li class="active"><a href="javascript:void(0)" onclick=to("adTipOffCheck")><i class="fa fa-circle-o"></i>举报审核</a></li>
                        <li><a href="javascript:void(0)" onclick=to("adTipOffInfo")><i class="fa fa-circle-o"></i>曝光台</a></li>
...
<script>
    $(function () {
        queryDatas("${pageContext.request.contextPath}/displayNonConfirmedTipOffs");
    })
            ...
            "columns":[
                ...
                {"data":"reason"},
                {
                    ...
                    "render": function (data) {
                        var opreate = "<div class='btn-group'><button type='button' class='btn btn-info btn-xs' id='pass' onclick='confirm("+data+")'>通过</button>";
                        opreate += "<button  type='button' class='btn btn-warning btn-xs' onclick='forbidNotice("+data+")' id='fail'>不通过</button></div>";
                        return opreate;
                    }
                }
            ],
    ...
    function confirm(id) {
        $.ajax({
            url:"${pageContext.request.contextPath}/confirmTipOff/"+id,
            type:"GET",
            dataType:"text",
    ...
    function forbidNotice(id) {
        $.ajax({
            url:"${pageContext.request.contextPath}/forbidTipOff/"+id,
            type:"GET",
            dataType:"text",
            success:function (result) {
                if (result == "success"){
