      ...
      <div class="row" >
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <li class="col-xs-10">
                <h3>教职工数量</h3> <span><strong><i>${kindergarten.KStuffs}</i></strong> </span>
            </li>
            <li class="col-xs-10">
                <h3>专职教师数量</h3> <span><strong><i>${kindergarten.KTeachers}</i></strong></span>
            </li>
            <li class="col-xs-10">
                <h3>学生总人数</h3> <span><strong><i>${kindergarten.KCapacity}</i></strong></span>
            </li>
            <li class="col-xs-10">
                <h3>每年招生人数</h3> <span><strong><i>${kindergarten.KCapacityYears}</i></strong></span>
            </li>
            <li class="col-xs-10">
                <h3>学校描述</h3> <span><strong><i>${kindergarten.KDescription}</i></strong></span>
                ...
                <div class="form-group col-xs-12 ">
                  <button type="button" class="btn btn-danger col-xs-offset-1" style="margin-top: 30px;" data-toggle="modal" data-target="#myModal-del">删除</button>
                    ...
                    <button type="button" class="btn btn-warning col-xs-offset-1" style="margin-top: 30px; margin-left: 30px;" onclick=toWithId("adKInfoDesChange","${kindergarten.KId}")>
                      <!-- <a href="adKInfoDesChange.html"></a> -->
                      修改</button>
                  
                    <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 30px;margin-left: 30px;" onclick=to("adKInfo")>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div style="width: 100%;text-align: right;">
              ...
              <button type="submit" class="btn btn-primary" style="margin-right: 14px;" onclick=deleteById(${kindergarten.KId})>
   ...
   function deleteById(id) {
        $.ajax({
            ...
            success: function (result) {
                if (result == "success") {
                  toWithId("adKInfo","${kindergarten.KId}")
