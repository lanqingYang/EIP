        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class=" active  treeview menu-open">
                    ...
                    <!-- 二级栏目 -->
                    <ul class="treeview-menu">
                        <li class="active"><a href="javascript:void(0)" onclick=to("adNoticeCheck")><i class="fa fa-circle-o"></i>
                            公告审核</a></li>
                ...
                <li class=" treeview">
                    ...
                    <!-- 二级栏目 -->
                    <ul class="treeview-menu">
                        <li><a href="javascript:void(0)" onclick=to("adTipOffCheck")><i class="fa fa-circle-o"></i>
                            举报审核</a></li>
...
<script>
    ...
    $(function () {
        queryDatas("${pageContext.request.contextPath}/displayNonConfirmedNotices");
    })
        ...
        $('#example1').DataTable({
            ...
            "columns":[
                ...
                {"data":"content"},
                {
                    "data":"id",
                    "render": function (data) {
                        var opreate = "<div class='btn-group'><button  type='button' class='btn btn-warning btn-xs' id='pass' onclick='confirm("+data+")'>通过</button>";
                        opreate += "<button type='button' class='btn btn-info btn-xs' onclick='forbid("+data+")' id='fail'>不通过</button></div>";
                        return opreate;
                    }
                }
            ],
    ...
    function confirm(id) {
        $.ajax({
            url:"${pageContext.request.contextPath}/confirmNotice/"+id,
            type:"GET",
            dataType:"text",
    ...
    function forbid(id) {
        $.ajax({
            url:"${pageContext.request.contextPath}/forbidNotice/"+id,
            type:"GET",
            dataType:"text",
            success:function (result) {
                if (result == "success"){
