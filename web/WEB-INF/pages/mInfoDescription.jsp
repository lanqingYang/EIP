              ...
              <div class="tab-pane  active" id="tab_1">
                ...
                <div class="box-body">
                  <ul class="miaoShu">
                    ...
                    <li class="col-xs-10">
                      <h3>教职工数量</h3>
                      <span><strong><i>${middleSchool.MSStuffs}</i></strong> </span>
                    </li>
                    <li class="col-xs-10">
                      <h3>专职教师数量</h3>
                      <span><strong><i>${middleSchool.MSTeachers}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学生总人数</h3>
                      <span><strong><i>${middleSchool.MSCapacity}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>每年招生人数</h3>
                      <span><strong><i>${middleSchool.MSCapacityYears}</i></strong></span>
                    </li>
                    <li class="col-xs-10">
                      <h3>学校描述</h3>
                      <span><strong><i>${middleSchool.MSDescription}</i></strong></span>

                    </li>
                    <div class="clear"></div>
                    <div class="form-group col-xs-10">
                      <button type="button" class="btn btn-info col-xs-offset-3"
                              style="margin-top: 20px;" onclick="to('mInfo')">返回
                      </button>
...
<script>
  ...
  function showMap() {
    ...
    var point = new BMap.Point(${middleSchool.MSPointY}, ${middleSchool.MSPointX});
 ...
 */
      ...
      datasets: [
        {
          ...
          data                : [${middleSchool.MSStuffs}, ${middleSchool.MSCapacity}]
        },
        {
          label               : 'Digital Goods',
          ...
          data                : [${middleSchool.MSTeachers}, ${middleSchool.MSCapacityYears}]
        }
      ]
    }
    ...
    var PieData = [
      {
        value: ${middleSchool.MSStuffs},
        color: "#f39c12",
        highlight: "#f39c12",
        label: "教职工",
      },
      {
        value: ${middleSchool.MSTeachers},
        color: "#3c8dbc",
        highlight: "#3c8dbc",
        label: "专职教师",
      },
